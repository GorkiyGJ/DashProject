...
namespace DashProject.Data.MsSql.Mapper
{
    public abstract class DashMediaMapperBase : DashProject.Data.Providers.DashMediaProvider
    {
        ...
        Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, item.TranscoderConfigId, "@TranscoderConfigId", SqlDbType.Int);
        Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, item.DashInitSegmentId, "@DashInitSegmentId", SqlDbType.Int);
        Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, item.CodecId, "@CodecId", SqlDbType.Int);
...
Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, Id, "@Id", SqlDbType.Int);
    ...
    public override void Get_IsHasInitSegment(Manitou.Data.Provider.SessionManager sm , System.Int32? DashMediaId, ref System.Boolean? IsHasInitSegment)
    {
        sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

        SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[_DashMedia_Get_IsHasInitSegment]" );        
Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, DashMediaId, "DashMediaId", SqlDbType.Int);
Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, IsHasInitSegment, "IsHasInitSegment", SqlDbType.Bit, ParameterDirection.Output);

            OnDataRequesting(new ItemEventArgs(sm, sc, "Get_IsHasInitSegment"));
...
IsHasInitSegment = Manitou.Helper.SqlUtils.GetParameterValue<System.Boolean?>(sc.Parameters["@IsHasInitSegment"].Value);
OnDataRequested(new ItemEventArgs(sm, sc, "Get_IsHasInitSegment"));
...
OnDataRequested(new ItemEventArgs(sm, sc, "Get_DashType_ById"));
    ...
    public override void Get_IsMain(Manitou.Data.Provider.SessionManager sm , System.Int32? DashMediaId, ref System.Boolean? IsMain)
    {
        sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

        SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[_DashMedia_Get_IsMain]" );        
Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, DashMediaId, "DashMediaId", SqlDbType.Int);
Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, IsMain, "IsMain", SqlDbType.Bit, ParameterDirection.Output);

            OnDataRequesting(new ItemEventArgs(sm, sc, "Get_IsMain"));
...
IsMain = Manitou.Helper.SqlUtils.GetParameterValue<System.Boolean?>(sc.Parameters["@IsMain"].Value);
OnDataRequested(new ItemEventArgs(sm, sc, "Get_IsMain"));
