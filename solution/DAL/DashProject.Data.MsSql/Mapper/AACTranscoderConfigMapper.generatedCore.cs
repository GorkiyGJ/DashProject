...
{
    public abstract class AACTranscoderConfigMapperBase : DashProject.Data.Providers.AACTranscoderConfigProvider
    {
        protected string connectionString;

        public AACTranscoderConfigMapperBase()
        {
                
        }
        
        public AACTranscoderConfigMapperBase(string connectionString) : this()
        {
        ...
        public override List<DashProject.Data.Item.AACTranscoderConfig> GetList(Manitou.Data.Provider.SessionManager sm, int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_AACTranscoderConfig_SelectTop]" );
            Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, count, "@RowCount", SqlDbType.Int);

            IDataReader dr = null;
            List<DashProject.Data.Item.AACTranscoderConfig> rows = null;
        ...
        public override List<DashProject.Data.Item.AACTranscoderConfig> GetPaged(Manitou.Data.Provider.SessionManager sm, string whereClause, string orderBy, int pageIndex, int pageSize, out int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_AACTranscoderConfig_GetPaged]" );
        ...
        public override bool Insert(SessionManager sm, DashProject.Data.Item.AACTranscoderConfig item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_AACTranscoderConfig_Insert]");
        ...
        Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, item.IsUseConstrainedBitRate, "@IsUseConstrainedBitRate", SqlDbType.Bit);
        ...
        public override bool Update(SessionManager sm, DashProject.Data.Item.AACTranscoderConfig item )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_AACTranscoderConfig_Update]");
        ...
        public override bool Delete(SessionManager sm, DashProject.Data.Item.AACTranscoderConfig item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_AACTranscoderConfig_Delete]");
    ...
    public override DashProject.Data.Item.AACTranscoderConfig GetById(Manitou.Data.Provider.SessionManager sm, System.Int32 Id )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_AACTranscoderConfig_GetById]" );
