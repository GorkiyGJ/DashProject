...
{
    public abstract class RawMediaMapperBase : DashProject.Data.Providers.RawMediaProvider
    {
        protected string connectionString;

        public RawMediaMapperBase()
        {
                
        }
        
        public RawMediaMapperBase(string connectionString) : this()
        {
        ...
        public override List<DashProject.Data.Item.RawMedia> GetList(Manitou.Data.Provider.SessionManager sm, int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMedia_SelectTop]" );
            Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, count, "@RowCount", SqlDbType.Int);

            IDataReader dr = null;
            List<DashProject.Data.Item.RawMedia> rows = null;
        ...
        public override List<DashProject.Data.Item.RawMedia> GetPaged(Manitou.Data.Provider.SessionManager sm, string whereClause, string orderBy, int pageIndex, int pageSize, out int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMedia_GetPaged]" );
        ...
        public override bool Insert(SessionManager sm, DashProject.Data.Item.RawMedia item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMedia_Insert]");

        Manitou.Data.MsSql.Helper.DbParameterUtils.AddOutParametr(sc, item.Id, "@Id", SqlDbType.Int);
        Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, item.ContainerTypeId, "@ContainerTypeId", SqlDbType.Int);
        Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, item.InputMedia, "@InputMedia", SqlDbType.NVarChar);
        Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, item.RawMediaSourceTypeId, "@RawMediaSourceTypeId", SqlDbType.TinyInt);
        ...
        public override bool Update(SessionManager sm, DashProject.Data.Item.RawMedia item )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMedia_Update]");
        ...
        public override bool Delete(SessionManager sm, DashProject.Data.Item.RawMedia item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMedia_Delete]");
    ...
    public override DashProject.Data.Item.RawMedia GetById(Manitou.Data.Provider.SessionManager sm, System.Int32 Id )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMedia_GetById]" );
