...
{
    public abstract class ScaleVideoFilterMapperBase : DashProject.Data.Providers.ScaleVideoFilterProvider
    {
        protected string connectionString;

        public ScaleVideoFilterMapperBase()
        {
                
        }
        
        public ScaleVideoFilterMapperBase(string connectionString) : this()
        {
        ...
        public override List<DashProject.Data.Item.ScaleVideoFilter> GetList(Manitou.Data.Provider.SessionManager sm, int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_ScaleVideoFilter_SelectTop]" );
            Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, count, "@RowCount", SqlDbType.Int);

            IDataReader dr = null;
            List<DashProject.Data.Item.ScaleVideoFilter> rows = null;
        ...
        public override List<DashProject.Data.Item.ScaleVideoFilter> GetPaged(Manitou.Data.Provider.SessionManager sm, string whereClause, string orderBy, int pageIndex, int pageSize, out int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_ScaleVideoFilter_GetPaged]" );
        ...
        public override bool Insert(SessionManager sm, DashProject.Data.Item.ScaleVideoFilter item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_ScaleVideoFilter_Insert]");
        ...
        public override bool Update(SessionManager sm, DashProject.Data.Item.ScaleVideoFilter item )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_ScaleVideoFilter_Update]");
        ...
        public override bool Delete(SessionManager sm, DashProject.Data.Item.ScaleVideoFilter item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_ScaleVideoFilter_Delete]");
    ...
    public override DashProject.Data.Item.ScaleVideoFilter GetById(Manitou.Data.Provider.SessionManager sm, System.Int32 Id )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_ScaleVideoFilter_GetById]" );
