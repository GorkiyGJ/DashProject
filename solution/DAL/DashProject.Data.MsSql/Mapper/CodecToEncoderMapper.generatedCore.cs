...
{
    public abstract class CodecToEncoderMapperBase : DashProject.Data.Providers.CodecToEncoderProvider
    {
        protected string connectionString;

        public CodecToEncoderMapperBase()
        {
                
        }
        
        public CodecToEncoderMapperBase(string connectionString) : this()
        {
        ...
        public override List<DashProject.Data.Item.CodecToEncoder> GetList(Manitou.Data.Provider.SessionManager sm, int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecToEncoder_SelectTop]" );
            Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, count, "@RowCount", SqlDbType.Int);

            IDataReader dr = null;
            List<DashProject.Data.Item.CodecToEncoder> rows = null;
        ...
        public override List<DashProject.Data.Item.CodecToEncoder> GetPaged(Manitou.Data.Provider.SessionManager sm, string whereClause, string orderBy, int pageIndex, int pageSize, out int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecToEncoder_GetPaged]" );
        ...
        public override bool Insert(SessionManager sm, DashProject.Data.Item.CodecToEncoder item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecToEncoder_Insert]");
        ...
        Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, item.EncoderTypeId, "@EncoderTypeId", SqlDbType.Int);
        Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, item.IsMain, "@IsMain", SqlDbType.Bit);
        ...
        public override bool Update(SessionManager sm, DashProject.Data.Item.CodecToEncoder item )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecToEncoder_Update]");
        ...
        public override bool Delete(SessionManager sm, DashProject.Data.Item.CodecToEncoder item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecToEncoder_Delete]");
    ...
    public override DashProject.Data.Item.CodecToEncoder GetById(Manitou.Data.Provider.SessionManager sm, System.Int32 Id )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecToEncoder_GetById]" );
