...
{
    public abstract class RawMediaSourceTypeMapperBase : DashProject.Data.Providers.RawMediaSourceTypeProvider
    {
        protected string connectionString;

        public RawMediaSourceTypeMapperBase()
        {
                
        }
        
        public RawMediaSourceTypeMapperBase(string connectionString) : this()
        {
        ...
        public override List<DashProject.Data.Item.RawMediaSourceType> GetList(Manitou.Data.Provider.SessionManager sm, int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMediaSourceType_SelectTop]" );
            Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, count, "@RowCount", SqlDbType.Int);

            IDataReader dr = null;
            List<DashProject.Data.Item.RawMediaSourceType> rows = null;
        ...
        public override List<DashProject.Data.Item.RawMediaSourceType> GetPaged(Manitou.Data.Provider.SessionManager sm, string whereClause, string orderBy, int pageIndex, int pageSize, out int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMediaSourceType_GetPaged]" );
        ...
        public override bool Insert(SessionManager sm, DashProject.Data.Item.RawMediaSourceType item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMediaSourceType_Insert]");
        ...
        public override bool Update(SessionManager sm, DashProject.Data.Item.RawMediaSourceType item )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMediaSourceType_Update]");
        ...
        public override bool Delete(SessionManager sm, DashProject.Data.Item.RawMediaSourceType item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMediaSourceType_Delete]");
    ...
    public override DashProject.Data.Item.RawMediaSourceType GetById(Manitou.Data.Provider.SessionManager sm, System.Byte Id )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_RawMediaSourceType_GetById]" );
