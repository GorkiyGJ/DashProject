...
{
    public abstract class X264ProfileMapperBase : DashProject.Data.Providers.X264ProfileProvider
    {
        protected string connectionString;

        public X264ProfileMapperBase()
        {
                
        }
        
        public X264ProfileMapperBase(string connectionString) : this()
        {
        ...
        public override List<DashProject.Data.Item.X264Profile> GetList(Manitou.Data.Provider.SessionManager sm, int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264Profile_SelectTop]" );
            Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, count, "@RowCount", SqlDbType.Int);

            IDataReader dr = null;
            List<DashProject.Data.Item.X264Profile> rows = null;
        ...
        public override List<DashProject.Data.Item.X264Profile> GetPaged(Manitou.Data.Provider.SessionManager sm, string whereClause, string orderBy, int pageIndex, int pageSize, out int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264Profile_GetPaged]" );
        ...
        public override bool Insert(SessionManager sm, DashProject.Data.Item.X264Profile item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264Profile_Insert]");
        ...
        public override bool Update(SessionManager sm, DashProject.Data.Item.X264Profile item )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264Profile_Update]");
        ...
        public override bool Delete(SessionManager sm, DashProject.Data.Item.X264Profile item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264Profile_Delete]");
    ...
    public override DashProject.Data.Item.X264Profile GetById(Manitou.Data.Provider.SessionManager sm, System.Int32 Id )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264Profile_GetById]" );
