...
{
    public abstract class LIBx264EncoderPresetTypeMapperBase : DashProject.Data.Providers.LIBx264EncoderPresetTypeProvider
    {
        protected string connectionString;

        public LIBx264EncoderPresetTypeMapperBase()
        {
                
        }
        
        public LIBx264EncoderPresetTypeMapperBase(string connectionString) : this()
        {
        ...
        public override List<DashProject.Data.Item.LIBx264EncoderPresetType> GetList(Manitou.Data.Provider.SessionManager sm, int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_LIBx264EncoderPresetType_SelectTop]" );
            Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, count, "@RowCount", SqlDbType.Int);

            IDataReader dr = null;
            List<DashProject.Data.Item.LIBx264EncoderPresetType> rows = null;
        ...
        public override List<DashProject.Data.Item.LIBx264EncoderPresetType> GetPaged(Manitou.Data.Provider.SessionManager sm, string whereClause, string orderBy, int pageIndex, int pageSize, out int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_LIBx264EncoderPresetType_GetPaged]" );
        ...
        public override bool Insert(SessionManager sm, DashProject.Data.Item.LIBx264EncoderPresetType item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_LIBx264EncoderPresetType_Insert]");
        ...
        public override bool Update(SessionManager sm, DashProject.Data.Item.LIBx264EncoderPresetType item )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_LIBx264EncoderPresetType_Update]");
        ...
        public override bool Delete(SessionManager sm, DashProject.Data.Item.LIBx264EncoderPresetType item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_LIBx264EncoderPresetType_Delete]");
    ...
    public override DashProject.Data.Item.LIBx264EncoderPresetType GetById(Manitou.Data.Provider.SessionManager sm, System.Int32 Id )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_LIBx264EncoderPresetType_GetById]" );
