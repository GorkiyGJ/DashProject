...
{
    public abstract class CodecMediaTypeMapperBase : DashProject.Data.Providers.CodecMediaTypeProvider
    {
        protected string connectionString;

        public CodecMediaTypeMapperBase()
        {
                
        }
        
        public CodecMediaTypeMapperBase(string connectionString) : this()
        {
        ...
        public override List<DashProject.Data.Item.CodecMediaType> GetList(Manitou.Data.Provider.SessionManager sm, int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecMediaType_SelectTop]" );
            Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, count, "@RowCount", SqlDbType.Int);

            IDataReader dr = null;
            List<DashProject.Data.Item.CodecMediaType> rows = null;
        ...
        public override List<DashProject.Data.Item.CodecMediaType> GetPaged(Manitou.Data.Provider.SessionManager sm, string whereClause, string orderBy, int pageIndex, int pageSize, out int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecMediaType_GetPaged]" );
        ...
        public override bool Insert(SessionManager sm, DashProject.Data.Item.CodecMediaType item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecMediaType_Insert]");
        ...
        public override bool Update(SessionManager sm, DashProject.Data.Item.CodecMediaType item )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecMediaType_Update]");
        ...
        public override bool Delete(SessionManager sm, DashProject.Data.Item.CodecMediaType item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecMediaType_Delete]");
    ...
    public override DashProject.Data.Item.CodecMediaType GetById(Manitou.Data.Provider.SessionManager sm, System.Int32 Id )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_CodecMediaType_GetById]" );
