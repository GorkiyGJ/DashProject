...
namespace DashProject.Data.MsSql.Mapper.Custom
{
    ...
    public override List<DashProject.Data.Item.Custom.iDashMediaInfo> Get_By_DashMediaId(Manitou.Data.Provider.SessionManager sm , System.Int32? DashMediaId)
    {
        sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

        SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[c_iDashMediaInfo_Get_By_DashMediaId]" );        
...
OnDataRequested(new ItemEventArgs(sm, sc, "Get_By_DashMediaId", rows));
    ...
    public override List<DashProject.Data.Item.Custom.iDashMediaInfo> Get_By_MediaId(Manitou.Data.Provider.SessionManager sm , System.Int32? MediaId)
    {
        sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

        SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[c_iDashMediaInfo_Get_By_MediaId]" );        
