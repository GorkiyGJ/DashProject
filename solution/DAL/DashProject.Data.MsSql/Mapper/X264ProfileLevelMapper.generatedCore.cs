...
{
    public abstract class X264ProfileLevelMapperBase : DashProject.Data.Providers.X264ProfileLevelProvider
    {
        protected string connectionString;

        public X264ProfileLevelMapperBase()
        {
                
        }
        
        public X264ProfileLevelMapperBase(string connectionString) : this()
        {
        ...
        public override List<DashProject.Data.Item.X264ProfileLevel> GetList(Manitou.Data.Provider.SessionManager sm, int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264ProfileLevel_SelectTop]" );
            Manitou.Data.MsSql.Helper.DbParameterUtils.AddParametr(sc, count, "@RowCount", SqlDbType.Int);

            IDataReader dr = null;
            List<DashProject.Data.Item.X264ProfileLevel> rows = null;
        ...
        public override List<DashProject.Data.Item.X264ProfileLevel> GetPaged(Manitou.Data.Provider.SessionManager sm, string whereClause, string orderBy, int pageIndex, int pageSize, out int count)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264ProfileLevel_GetPaged]" );
        ...
        public override bool Insert(SessionManager sm, DashProject.Data.Item.X264ProfileLevel item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264ProfileLevel_Insert]");
        ...
        public override bool Update(SessionManager sm, DashProject.Data.Item.X264ProfileLevel item )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264ProfileLevel_Update]");
        ...
        public override bool Delete(SessionManager sm, DashProject.Data.Item.X264ProfileLevel item)
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264ProfileLevel_Delete]");
    ...
    public override DashProject.Data.Item.X264ProfileLevel GetById(Manitou.Data.Provider.SessionManager sm, System.Int32 Id )
        {
            sm = Manitou.Data.MsSql.Helper.DbConnectionUtils.GetConnection(connectionString, sm);

            SqlCommand sc = Manitou.Data.MsSql.Helper.DbCommandUtils.GetCommand(sm, "[dbo].[i_X264ProfileLevel_GetById]" );
