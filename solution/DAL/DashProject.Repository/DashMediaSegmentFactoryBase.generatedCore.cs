...
namespace DashProject.Repository
{
    ...
    public virtual void GetId_By_DashMediaId_DecodeTimeTS( System.Int32? DashMediaId,  System.Int64? DecodeTimeTS, ref System.Int32? DashMediaSegmentId)
    {               
GetId_By_DashMediaId_DecodeTimeTS(null , DashMediaId, DecodeTimeTS, ref DashMediaSegmentId);
      
    }
    
        public virtual void GetId_By_DashMediaId_DecodeTimeTS(Manitou.Data.Provider.SessionManager sm , System.Int32? DashMediaId, System.Int64? DecodeTimeTS, ref System.Int32? DashMediaSegmentId)
        {
            OnDataRequesting(new EntityEventArgs(sm, "GetId_By_DashMediaId_DecodeTimeTS"));

            Data.DataProvider.Provider.DashMediaSegmentProvider.GetId_By_DashMediaId_DecodeTimeTS(sm, DashMediaId, DecodeTimeTS, ref DashMediaSegmentId);
                       
            OnDataRequested(new EntityEventArgs(sm, "GetId_By_DashMediaId_DecodeTimeTS"));                                  
