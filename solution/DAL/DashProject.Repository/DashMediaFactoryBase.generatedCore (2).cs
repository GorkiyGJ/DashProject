...
namespace DashProject.Repository
{
    ...
    public virtual void Get_IsHasInitSegment( System.Int32? DashMediaId, ref System.Boolean? IsHasInitSegment)
    {               
Get_IsHasInitSegment(null , DashMediaId, ref IsHasInitSegment);
      
    }
    
        public virtual void Get_IsHasInitSegment(Manitou.Data.Provider.SessionManager sm , System.Int32? DashMediaId, ref System.Boolean? IsHasInitSegment)
        {
            OnDataRequesting(new EntityEventArgs(sm, "Get_IsHasInitSegment"));

            Data.DataProvider.Provider.DashMediaProvider.Get_IsHasInitSegment(sm, DashMediaId, ref IsHasInitSegment);
                       
            OnDataRequested(new EntityEventArgs(sm, "Get_IsHasInitSegment"));                                  
...
Get_DashType_ById(null , DashMediaId, ref DashTypeId);
    ...
    public virtual void Get_IsMain( System.Int32? DashMediaId, ref System.Boolean? IsMain)
    {               
Get_IsMain(null , DashMediaId, ref IsMain);
      
    }
    
        public virtual void Get_IsMain(Manitou.Data.Provider.SessionManager sm , System.Int32? DashMediaId, ref System.Boolean? IsMain)
        {
            OnDataRequesting(new EntityEventArgs(sm, "Get_IsMain"));

            Data.DataProvider.Provider.DashMediaProvider.Get_IsMain(sm, DashMediaId, ref IsMain);
                       
            OnDataRequested(new EntityEventArgs(sm, "Get_IsMain"));                                  
