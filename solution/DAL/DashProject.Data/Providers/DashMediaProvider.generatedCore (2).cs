...
namespace DashProject.Data.Providers
{
    public abstract class DashMediaProviderBase : Manitou.Data.Provider.ItemProviderBase<DashProject.Data.Item.DashMedia>
    {
        public static List<DashProject.Data.Item.DashMedia> Fill(IDataReader dr)
        {
            ...
            while (dr.Read())
            {
                ...
                row.TranscoderConfigId = (System.Int32)dr[((byte)DashMediaBase.DashMediaColumn.TranscoderConfigId - 1)];
                ...
                row.CodecId = (System.Int32)dr[((byte)DashMediaBase.DashMediaColumn.CodecId - 1)];
                ...
                row.IsMain = (System.Boolean)dr[((byte)DashMediaBase.DashMediaColumn.IsMain - 1)];
    ...
    public virtual void Get_IsHasInitSegment(ref System.Int32? DashMediaId, ref System.Boolean? IsHasInitSegment)
    {               
Get_IsHasInitSegment(null , DashMediaId, ref IsHasInitSegment);
      
    }
    
    public abstract void Get_IsHasInitSegment(Manitou.Data.Provider.SessionManager sm , System.Int32? DashMediaId, ref System.Boolean? IsHasInitSegment);
...
Get_DashType_ById(null , DashMediaId, ref DashTypeId);
    ...
    public virtual void Get_IsMain(ref System.Int32? DashMediaId, ref System.Boolean? IsMain)
    {               
Get_IsMain(null , DashMediaId, ref IsMain);
      
    }
    
    public abstract void Get_IsMain(Manitou.Data.Provider.SessionManager sm , System.Int32? DashMediaId, ref System.Boolean? IsMain);
