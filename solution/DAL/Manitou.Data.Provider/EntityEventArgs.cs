...
namespace Manitou.Data.Provider
{
    public class EntityEventArgs
    {
        ...
        public EntityEventArgs(SessionManager session, string methodName, Data.Item.Base.IBaseItem item, IList list)
            : this()
        {
            Session = session;
        ...
        public EntityEventArgs(SessionManager session, string methodName, IList list)
            : this(session, methodName, null, list)
        { 
        }

        public EntityEventArgs(SessionManager session, string methodName)
            : this(session, methodName, null, null)
        { 
        }

        public EntityEventArgs(SessionManager session, string methodName, Data.Item.Base.IBaseItem item)
